...
#   distclean		- remove all files generated by compilation/installation
...
top_srcdir = .
topdir = /Users/jonathanhall/git/BitchX1.3
prefix = /usr/local
exec_prefix = ${prefix}
...
LIBS =  -lncurses -lssl -lcrypto -lresolv -lm
...
CFLAGS =  -g -O2 -fno-strict-aliasing -I/opt/homebrew/include -Wall
